    ...
    <div><!-- ---------------------------------- -->
        ...
        <div class="brand-logo d-flex align-items-center justify-content-between">
            <a href="../main/index.html" class="text-nowrap logo-img">
                <img src="{{asset('images/saborzen-original.png')}}" style="width: 70px" class="dark-logo" alt="Logo-Dark">
                <img src="{{asset('images/saborzen-original.png')}}" style="width: 70px" class="light-logo" alt="Logo-light"
                    style="display: none;">
            </a>
