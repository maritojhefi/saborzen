    ...
    <div><!-- ---------------------------------- -->
        ...
        <div class="brand-logo d-flex align-items-center justify-content-between">
            <a href="#" class="text-nowrap logo-img">
                <img src="{{asset('images/saborzen-original.png')}}" style="width: 50px" class="dark-logo" alt="Logo-Dark">
                <img src="{{asset('images/saborzen-original.png')}}" style="width: 50px" class="light-logo" alt="Logo-light"
                    style="display: none;">
            </a>
        ...
        <nav class="sidebar-nav scroll-sidebar simplebar-scrollable-y" data-simplebar="init">
            <div class="simplebar-wrapper selected" style="margin: 0px -24px;">
                            ...
                            <div class="simplebar-content selected" style="padding: 0px 24px;">
                                <ul id="sidebarnav" class="in">
                                    ...
                                    <li class="sidebar-item selected">
                                        <a class="sidebar-link active" href="../main/index5.html" aria-expanded="false">
                                            <span>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="../main/app-contact2.html"
                                            aria-expanded="false">
                                            <span>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="../main/app-invoice.html"
                                            aria-expanded="false">
                                            <span>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="../main/page-user-profile.html"
                                            aria-expanded="false">
                                            <span>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="../main/page-pricing.html"
                                            aria-expanded="false">
                                            <span>
                                                <i class="ti ti-currency-dollar"></i>
                                            </span>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="../main/page-account-settings.html"
                                            aria-expanded="false">
                                            <span>
                                                <i class="ti ti-user-circle"></i>
                                            </span>
                                    ...
                                    <li class="sidebar-item">
                                        ...
                                        <ul aria-expanded="false" class="collapse first-level">
                                            ...
                                            <li class="sidebar-item">
                                                <a href="../main/form-picker-datetimepicker.html"
                                                    class="sidebar-link">
                                                    <div
                                                        class="round-16 d-flex align-items-center justify-content-center">
                                                        <i class="ti ti-circle"></i>
                                            ...
                                            <li class="sidebar-item">
                                                <a href="../main/form-picker-bootstrap-rangepicker.html"
                                                    class="sidebar-link">
                                                    <div
                                                        class="round-16 d-flex align-items-center justify-content-center">
                                                        <i class="ti ti-circle"></i>
                                            ...
                                            <li class="sidebar-item">
                                                <a href="../main/form-picker-bootstrap-datepicker.html"
                                                    class="sidebar-link">
                                                    <div
                                                        class="round-16 d-flex align-items-center justify-content-center">
                                                        <i class="ti ti-circle"></i>
                                            ...
                                            <li class="sidebar-item">
                                                <a href="../main/form-picker-material-datepicker.html"
                                                    class="sidebar-link">
                                                    <div
                                                        class="round-16 d-flex align-items-center justify-content-center">
                                                        <i class="ti ti-circle"></i>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="../main/form-vertical.html"
                                            aria-expanded="false">
                                            <span class="d-flex">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="../main/form-horizontal.html"
                                            aria-expanded="false">
                                            <span class="d-flex">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="../main/form-actions.html"
                                            aria-expanded="false">
                                            <span class="d-flex">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="../main/form-row-separator.html"
                                            aria-expanded="false">
                                            <span class="d-flex">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="../main/form-bordered.html"
                                            aria-expanded="false">
                                            <span class="d-flex">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="../main/form-detail.html"
                                            aria-expanded="false">
                                            <span class="d-flex">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="../main/form-striped-row.html"
                                            aria-expanded="false">
                                            <span class="d-flex">
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="../main/form-floating-input.html"
                                            aria-expanded="false">
                                            <span class="d-flex">
                                    ...
                                    <!-- ---------------------------------- -->
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="../main/form-wizard.html"
                                            aria-expanded="false">
                                            <span class="d-flex">
                                    ...
                                    <!-- ---------------------------------- -->
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="../main/form-repeater.html"
                                            aria-expanded="false">
                                            <span class="d-flex">
                                    ...
                                    <!-- ---------------------------------- -->
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="../main/table-jsgrid.html"
                                            aria-expanded="false">
                                            <span class="d-flex">
                                    ...
                                    <!-- ---------------------------------- -->
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="../main/table-responsive.html"
                                            aria-expanded="false">
                                            <span class="d-flex">
                                    ...
                                    <!-- ---------------------------------- -->
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="../main/table-footable.html"
                                            aria-expanded="false">
                                            <span class="d-flex">
                                    ...
                                    <!-- ---------------------------------- -->
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="../main/table-editable.html"
                                            aria-expanded="false">
                                            <span class="d-flex">
                                    ...
                                    <!-- ---------------------------------- -->
                                    <li class="sidebar-item">
                                        <a class="sidebar-link" href="../main/table-bootstrap.html"
                                            aria-expanded="false">
                                            <span class="d-flex">
                                                <i class="ti ti-border-outer"></i>
                                            </span>
                                    ...
                                    <li class="sidebar-item">
                                        ...
                                        <ul aria-expanded="false" class="collapse first-level">
                                            ...
                                            <li class="sidebar-item">
                                                <a href="../main/authentication-forgot-password2.html"
                                                    class="sidebar-link">
                                                    <div
                                                        class="round-16 d-flex align-items-center justify-content-center">
                                                        <i class="ti ti-circle"></i>
                                    ...
                                    <li class="sidebar-item">
                                        ...
                                        <ul aria-expanded="false" class="collapse first-level">
                                            <li class="sidebar-item">
                                                <a href="../main/authentication-two-steps.html"
                                                    class="sidebar-link">
                                                    <div
                                                        class="round-16 d-flex align-items-center justify-content-center">
                                                        <i class="ti ti-circle"></i>
                                            ...
                                            <li class="sidebar-item">
                                                <a href="../main/authentication-two-steps2.html"
                                                    class="sidebar-link">
                                                    <div
                                                        class="round-16 d-flex align-items-center justify-content-center">
                                                        <i class="ti ti-circle"></i>
                                    ...
                                    <li class="sidebar-item">
                                        <a class="sidebar-link sidebar-link"
                                            href="../main/authentication-maintenance.html" aria-expanded="false">
                                            <span class="rounded-3">
                ...
                <div class="simplebar-placeholder" style="width: 269px; height: 3588px;"></div>
            </div>
            ...
            <div class="simplebar-track simplebar-vertical" style="visibility: visible;">
                <div class="simplebar-scrollbar"
                    style="height: 81px; transform: translate3d(0px, 0px, 0px); display: block;"></div>
            </div>
        </nav>
        ...
        <div class="fixed-profile p-3 mx-4 mb-2 bg-secondary-subtle rounded mt-3">
            <div class="hstack gap-3">
                <div class="john-img">
                    <img src="{{asset('images/saborzen-original.png')}}" class="rounded-circle" width="40"
                        height="40" alt="">
                </div>
