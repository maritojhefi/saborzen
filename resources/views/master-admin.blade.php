...
<head>
    ...
    <meta name="description" content="Tecnología a tu alcance" />
    <meta name="author" content="" />
    <meta name="keywords" content="" />
    <meta http-equiv="X-UA-Compatible" content="IE=edge" />
    <!--  Favicon -->
    <link rel="shortcut icon" type="image/png" href="{{ asset('images/saborzen-blanco.png') }}" />
    @vite(['resources/sass/app.scss', 'resources/js/app.js'])
</head>

<body data-sidebartype="full">
    <div class="preloader">
        <div id="pelogo" class="lds-ripple img-fluid">
            <div class="loader-circle"></div>
            <div class="loader-line-mask">
                <div class="loader-line"></div>
            </div>
            <img src="{{ asset('images/saborzen-negro.png') }}" class="img-loader" width="100" />
        </div>
    </div>
                                                                    ...
                                                                    <a href="javascript:void(0)"
                                                                        ...
                                                                        <div class="w-75 d-inline-block v-middle">
                                                                            <h6 class="mb-1 fw-semibold lh-base">New
                                                                                message</h6>
                                                                            <span
                                                                                class="fs-2 d-block text-body-secondary">Salma
                                                                    ...
                                                                    <a href="javascript:void(0)"
                                                                        ...
                                                                        <div class="w-75 d-inline-block v-middle">
                                                                            <h6 class="mb-1 fw-semibold lh-base">Bianca
                                                                                sent payment</h6>
                                                                            <span
                                                                                class="fs-2 d-block text-body-secondary">Check
                                                                                your earnings</span>
                                                                        </div>
                                                                    </a>
                                                                    <a href="javascript:void(0)"
                                                                        ...
                                                                        <div class="w-75 d-inline-block v-middle">
                                                                            <h6 class="mb-1 fw-semibold lh-base">Jolly
                                                                                completed tasks</h6>
                                                                            <span
                                                                                class="fs-2 d-block text-body-secondary">Assign
                                                                                her new tasks</span>
                                                                        </div>
                                                                    </a>
                                                                    <a href="javascript:void(0)"
                                                                        ...
                                                                        <div class="w-75 d-inline-block v-middle">
                                                                            <h6 class="mb-1 fw-semibold lh-base">John
                                                                                received payment</h6>
                                                                            <span
                                                                                class="fs-2 d-block text-body-secondary">$230
                                                                ...
                                                                <div class="simplebar-content" style="padding: 0px;">
                                                                    ...
                                                                    <div class="message-body">
                                                                        <a href="../main/page-user-profile.html"
                                                                            ...
                                                                            <div
                                                                                class="w-75 d-inline-block v-middle ps-3">
                                                                                <h6
                                                                    ...
                                                                    <div class="d-grid py-4 px-7 pt-8">
                                                                        <div
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-6">
                                                                                    <h5
                                                                                        class="fs-4 mb-3 w-50 fw-semibold">
                                                                                        Unlimited Access</h5>
                                                                                    <button
